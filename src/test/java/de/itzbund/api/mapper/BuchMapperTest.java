...
class BuchMapperTest {
    ...
    void toEntityMapsFields() {
        BuchDtos.CreateRequest req = BuchDtos.CreateRequest.builder()
                .title("Test")
                .author("Author")
                .isbn("1234567890")
                .pages(10)
    ...
    void updateEntityCopiesFields() {
        Buch entity = Buch.builder()
                ...
                .price(BigDecimal.ONE)
                .build();
        BuchDtos.UpdateRequest upd = BuchDtos.UpdateRequest.builder()
                .title("New")
                .author("NewA")
                .isbn("222")
                .pages(2)
    ...
    void toResponseMapsFields() {
        Buch entity = Buch.builder()
                ...
                .version(7L)
                .build();
        BuchDtos.Response resp = BuchMapper.toResponse(entity);
